 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(_,N){var T=_.length;_.push(N);e:for(;0<T;){var A=T-1>>>1,F=_[A];if(0<o(F,N))_[A]=N,_[T]=F,T=A;else break e}}function n(_){return _.length===0?null:_[0]}function r(_){if(_.length===0)return null;var N=_[0],T=_.pop();if(T!==N){_[0]=T;e:for(var A=0,F=_.length,Bt=F>>>1;A<Bt;){var Ue=2*(A+1)-1,mt=_[Ue],Ee=Ue+1,nt=_[Ee];if(0>o(mt,T))Ee<F&&0>o(nt,mt)?(_[A]=nt,_[Ee]=T,A=Ee):(_[A]=mt,_[Ue]=T,A=Ue);else if(Ee<F&&0>o(nt,T))_[A]=nt,_[Ee]=T,A=Ee;else break e}}return N}function o(_,N){var T=_.sortIndex-N.sortIndex;return T!==0?T:_.id-N.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var l=Date,a=l.now();e.unstable_now=function(){return l.now()-a}}var s=[],u=[],g=1,h=null,m=3,v=!1,w=!1,E=!1,$=typeof setTimeout=="function"?setTimeout:null,d=typeof clearTimeout=="function"?clearTimeout:null,c=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function f(_){for(var N=n(u);N!==null;){if(N.callback===null)r(u);else if(N.startTime<=_)r(u),N.sortIndex=N.expirationTime,t(s,N);else break;N=n(u)}}function x(_){if(E=!1,f(_),!w)if(n(s)!==null)w=!0,Wn(j);else{var N=n(u);N!==null&&Ut(x,N.startTime-_)}}function j(_,N){w=!1,E&&(E=!1,d(z),z=-1),v=!0;var T=m;try{for(f(N),h=n(s);h!==null&&(!(h.expirationTime>N)||_&&!Se());){var A=h.callback;if(typeof A=="function"){h.callback=null,m=h.priorityLevel;var F=A(h.expirationTime<=N);N=e.unstable_now(),typeof F=="function"?h.callback=F:h===n(s)&&r(s),f(N)}else r(s);h=n(s)}if(h!==null)var Bt=!0;else{var Ue=n(u);Ue!==null&&Ut(x,Ue.startTime-N),Bt=!1}return Bt}finally{h=null,m=T,v=!1}}var C=!1,k=null,z=-1,U=5,D=-1;function Se(){return!(e.unstable_now()-D<U)}function At(){if(k!==null){var _=e.unstable_now();D=_;var N=!0;try{N=k(!0,_)}finally{N?Ft():(C=!1,k=null)}}else C=!1}var Ft;if(typeof c=="function")Ft=function(){c(At)};else if(typeof MessageChannel<"u"){var Ur=new MessageChannel,Si=Ur.port2;Ur.port1.onmessage=At,Ft=function(){Si.postMessage(null)}}else Ft=function(){$(At,0)};function Wn(_){k=_,C||(C=!0,Ft())}function Ut(_,N){z=$(function(){_(e.unstable_now())},N)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(_){_.callback=null},e.unstable_continueExecution=function(){w||v||(w=!0,Wn(j))},e.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):U=0<_?Math.floor(1e3/_):5},e.unstable_getCurrentPriorityLevel=function(){return m},e.unstable_getFirstCallbackNode=function(){return n(s)},e.unstable_next=function(_){switch(m){case 1:case 2:case 3:var N=3;break;default:N=m}var T=m;m=N;try{return _()}finally{m=T}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(_,N){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var T=m;m=_;try{return N()}finally{m=T}},e.unstable_scheduleCallback=function(_,N,T){var A=e.unstable_now();switch(typeof T=="object"&&T!==null?(T=T.delay,T=typeof T=="number"&&0<T?A+T:A):T=A,_){case 1:var F=-1;break;case 2:F=250;break;case 5:F=1073741823;break;case 4:F=1e4;break;default:F=5e3}return F=T+F,_={id:g++,callback:N,priorityLevel:_,startTime:T,expirationTime:F,sortIndex:-1},T>A?(_.sortIndex=T,t(u,_),n(s)===null&&_===n(u)&&(E?(d(z),z=-1):E=!0,Ut(x,T-A))):(_.sortIndex=F,t(s,_),w||v||(w=!0,Wn(j))),_},e.unstable_shouldYield=Se,e.unstable_wrapCallback=function(_){var N=m;return function(){var T=m;m=N;try{return _.apply(this,arguments)}finally{m=T}}}})(Hu);Bu.exports=Hu;var Ff=Bu.exports;/**
 * @license React
...
`,qg=y(hf)`
  margin-top: 2rem;
  padding-top: 1.5rem;
`,ev=({icon:e,title:t,subtitle:n,shortDescription:r,fullDescription:o,startDate:i,endDate:l,companyLogo:a,tags:s=[]})=>{const[u,g]=W.useState(!1),[h,m]=W.useState(!1),v=$=>$?new Date($).toLocaleDateString("en-US",{month:"short",year:"numeric"}):"Present",w=()=>{g(!u)},E=$=>{$.stopPropagation(),m(!0)};return p.jsxs(p.Fragment,{children:[p.jsxs(Hg,{onClick:w,children:[p.jsxs(Vg,{$isExpanded:u,children:[p.jsxs(Wg,{children:[p.jsxs(Qg,{children:[p.jsx("span",{className:"icon",children:e}),t]}),p.jsxs(Yg,{children:[a&&p.jsx(Gg,{src:a,alt:n}),n,p.jsxs(bg,{children:[v(i)," - ",v(l)]})]})]}),p.jsxs(Kg,{$isExpanded:u,onClick:E,"aria-label":"View full details",children:["View Details",p.jsx("i",{className:"fas fa-external-link-alt"})]})]}),p.jsx(Xg,{$isExpanded:u,children:p.jsxs(Zg,{children:[r,s.length>0&&p.jsx(hf,{children:s.map(($,d)=>p.jsx(zu,{children:$},d))})]})})]}),p.jsx(Bg,{isOpen:h,onClose:()=>m(!1),title:t,subtitle:n,icon:e,children:p.jsxs(Jg,{children:[o,s.length>0&&p.jsx(qg,{children:s.map(($,d)=>p.jsx(zu,{children:$},d))})]})})]})},tv=y.div`
  text-align: center;
  margin-top: 3rem;
  padding: 2rem;
  background: var(--card-bg);
